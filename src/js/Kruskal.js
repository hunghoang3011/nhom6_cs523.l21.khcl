...
Graph.prototype.Kruskal = function() {
	...
	for (var i = 0; i < edgeArray.length; i++) {
		this.cmd("CreateCircle", this.EdgeArrayObjectID[2 * i], edgeArray[i].startVertex, this.EdgeArrayObjectStartX, this.EdgeArrayObjectStartY + i * (this.EdgeArrayObjectInterval + 2 * this.EdgeArrayObjectRadius), this.EdgeArrayObjectRadius);
		...
		this.cmd("CreateCircle", this.EdgeArrayObjectID[2 * i + 1], edgeArray[i].endVertex, this.EdgeArrayObjectStartX + 2 * this.EdgeArrayObjectRadius + this.EdgeArrayLineLength, this.EdgeArrayObjectStartY + i * (this.EdgeArrayObjectInterval + 2 * (this.EdgeArrayObjectRadius)), this.EdgeArrayObjectRadius);
	...
	for (var i = 0; i < this.vertexNum; i++) {
		this.cmd("CreateRectangle", this.UFSetsObjectID[i], i, this.UFSetsObjectWidth, this.UFSetsObjectHeight, 'center', 'center', this.UFSetsObjectPosition[i][0], this.UFSetsObjectPosition[i][1]);
	...
	while (MSTEdge.length < this.vertexNum - 1) {
		if (edgeCount < edgeArray.length) {
			...
			this.cmd("CreateHighlightCircle", this.EdgeArrayLeftHighlightCircleID, this.EdgeArrayObjectStartX, this.EdgeArrayObjectStartY, this.EdgeArrayObjectRadius / 2);
			...
			this.cmd("CreateHighlightCircle", this.EdgeArrayRightHighlightCircleID, this.EdgeArrayObjectStartX + this.EdgeArrayLineLength + 2 * this.EdgeArrayObjectRadius, this.EdgeArrayObjectStartY, this.EdgeArrayObjectRadius / 2);
			...
			this.cmd("Step");
			this.cmd("Move", this.EdgeArrayLeftHighlightCircleID, this.UFSetsObjectPosition[startVertex][0], this.UFSetsObjectPosition[startVertex][1]);
			this.cmd("Move", this.EdgeArrayRightHighlightCircleID, this.UFSetsObjectPosition[endVertex][0], this.UFSetsObjectPosition[endVertex][1]);
			this.cmd("Step");
			this.cmd("Step");
			...
			if (!set.check(startVertex, endVertex)) {
				...
				for (var i = 0; i < this.vertexNum; i++) {
					...
					this.cmd("Move", this.UFSetsObjectID[i], this.UFSetsObjectPosition[i][0], this.UFSetsObjectPosition[i][1]);
					this.UFSetsObjectCount[set.find(i)]++;
				}
				this.cmd("Step");
				if (!hasHighlightCiecle[startVertex]) {
					this.cmd("CreateHighlightCircle", this.highightCircleID[startVertex], this.position[startVertex][0], this.position[startVertex][1], this.radius);
					hasHighlightCiecle[startVertex] = true;
				}
				if (!hasHighlightCiecle[endVertex]) {
					this.cmd("CreateHighlightCircle", this.highightCircleID[endVertex], this.position[endVertex][0], this.position[endVertex][1], this.radius);
			...
			for (var i = edgeCount + 1; i < edgeArray.length; i++) {
				this.cmd("Move", this.EdgeArrayObjectID[2 * i], this.EdgeArrayObjectStartX, this.EdgeArrayObjectStartY + (i - edgeCount - 1) * (this.EdgeArrayObjectInterval + 2 * this.EdgeArrayObjectRadius));
				this.cmd("Move", this.EdgeArrayObjectID[2 * i + 1], this.EdgeArrayObjectStartX + this.EdgeArrayLineLength + 2 * this.EdgeArrayObjectRadius, this.EdgeArrayObjectStartY + (i - edgeCount - 1) * (this.EdgeArrayObjectInterval + 2 * this.EdgeArrayObjectRadius));
			}
			this.cmd("Step");
		} else {
